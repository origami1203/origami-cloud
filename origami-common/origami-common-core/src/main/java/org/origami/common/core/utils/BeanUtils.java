...
public abstract class BeanUtils {
     ...
     */
    public static Map<String, Object> beanToMap(Object bean, boolean camelToUnderscore, boolean ignoreNullValue) {
     ...
     * @return {@code T}
     */
    public static <T> T mapToBean(Map<?, ?> map, Class<T> beanClass, String... ignoreProperties) {
        return BeanUtil.mapToBean(map, beanClass, false, CopyOptions.create().setIgnoreProperties(ignoreProperties));
    }
