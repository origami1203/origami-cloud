...
public class UserDetailsServiceProvider implements UserDetailsService, Ordered {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return new AuthUser(authUser.getUsername(), authUser.getPassword(), authUser.getEnabled(), roles);
